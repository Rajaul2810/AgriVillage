...
const events = [
  {
    id: 1,
    name: "রবি উৎসব",
    address: "সাভার,আশুলিয়া",
    description: "আমাদের এই উৎসবে পেয়ে যাবেন শীতকালীন সকল সবজির এক ব্যাপক সমাহার।সারা বাংলাদেশ হতে প্রান্তিক কৃষকেরা তাদের উৎপাদিত কৃষিপণ্য ,কৃষক পত্নীর তৈরী গৃহস্থালি পণ্য,মৌসুমি ফল নিয়ে হাজির হবেন আপনাদের সামনে।কৃষক পাবে প্রাপ্য মূল্য আপনি পাবেন নির্ভেজাল দেশজ কৃষির ছোঁয়া।",
    photo: robi,
    date: "১৫-২০ জানুয়ারি, ২০২৪",
    time: "সকাল ৯টা - রাত ৮টা",
    entryFee: "৫০ টাকা",
    facilities: ["পার্কিং", "টয়লেট", "খাবার কর্নার", "বিশ্রাম স্থান"],
    contact: "০১৭১২-৩৪৫৬৭৮",
    activities: ["কৃষি পণ্য প্রদর্শনী", "কৃষক সম্মেলন", "সাংস্কৃতিক অনুষ্ঠান"]
  },
  
  {
    id: 2,
    name: "পিঠা উৎসব",
    address: "নতুন ক্যাম্পাস,জগন্নাথ বিশ্ববিদ্যালয়",
    description: "বিশ্বের সবচেয়ে বড় পিঠা উৎসবে আপনাকে স্বাগতম।পিঠা উৎসবে গিয়ে পাবেন ভিন্ন ভিন্ন স্টলে সাজানো  নানান রকমের পিঠা-পুলি। থাকবে সুইচ রোল পুলি, চন্দন কাঠ, সুজির মালাই চাপ, ম্যারা পিঠা, নারকেল পুলি পিঠা, দুধ চিতই, ভাপা পিঠা, ফুলঝুরি পিঠা, সেমাই পিঠা, সাগু রিং, কেক, গোলাপ পিঠা, ডালের পিঠা, পুডিং, দুধ মালাই রিং, দুধ সন্দেশ, নারকেল চমচম, তেলের পিঠা, নারকেল পাকন, নুডুলস পিঠা, চুষি পিঠা, সাজের পিঠা পাঠিসাপটাসহ ভিন্ন স্বাদের বৈচিত্র্যময় পিঠা।",
    photo: pita,
    date: "১-৭ পৌষ, ১৪৩০",
    time: "সকাল ১০টা - রাত ১০টা", 
    entryFee: "৩০ টাকা",
    facilities: ["পার্কিং", "টয়লেট", "বসার ব্যবস্থা", "হাত ধোয়ার জায়গা"],
    contact: "০১৮১৫-৯৮৭৬৫৪",
    activities: ["পিঠা তৈরি প্রদর্শন", "পিঠা খাওয়া", "ফোটো তোলা"]
  },
  {
    id: 3,
    name: "মধুমাসী উৎসব",
    address: "সারিঘাট,কেরানীগঞ্জ",
    description: "আমাদের এই উৎসবে পেয়ে যাবেন গ্রীষ্মকালীন সকল ফলের এক ব্যাপক সমাহার।রাজশাহী,চাপাইনবাবগঞ্জ,দিনাজপুর,বরিশাল সহ দেশের ৬৪ জেলা হতে উৎপাদিত মৌসুমি ফল এসে হাজির হবে আপনাদের সামনে।সম্পূর্ণ অর্গানিক,নির্ভেজাল,বিষমুক্ত ফল পেয়ে যাবেন সুলভ মূল্যে।",
    photo: veg,
    date: "১-১৫ জ্যৈষ্ঠ, ১৪৩০",
    time: "সকাল ৮টা - রাত ৯টা",
    entryFee: "৪০ টাকা",
    facilities: ["পার্কিং", "টয়লেট", "ক্যাফেটেরিয়া", "প্রাথমিক চিকিৎসা"],
    contact: "০১৯১৪-৭৮৯০১২",
    activities: ["ফল প্রদর্শনী", "ফল ক্রয়-বিক্রয়", "কৃষি সেমিনার"]
  }
]
