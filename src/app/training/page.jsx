...
import { FiArrowUpRight, FiMapPin, FiClock, FiCalendar, FiUsers, FiX } from "react-icons/fi";
    ...
    <div className='min-h-screen bg-gradient-to-b from-gray-50 to-gray-100'>
      <div className="container mx-auto px-4 py-16">
        <div className="flex flex-col items-center gap-6 mb-16">
          ...
          <h2 className="text-3xl font-bold text-center text-gray-800">Available Workshops</h2>
          <p className="text-gray-600 text-center max-w-2xl">Join our comprehensive training programs designed to help you master urban farming and sustainable agriculture techniques.</p>
        </div>
        
        <div className="w-11/12 mx-auto md:w-10/12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {training.map((workshop) => (
            <div key={workshop.id} className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-gray-50 rounded-lg">
                    {workshop.icon}
                  </div>
                  <span className={`px-4 py-1.5 rounded-full text-xs font-semibold ${workshop.type === 'Online' ? 'bg-blue-100 text-blue-700' : 'bg-emerald-100 text-emerald-700'}`}>
                    {workshop.type}
                  </span>
                </div>
