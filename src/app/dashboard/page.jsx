    ...
    <section>
      <div>
        <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          <div className=" bg-white  shadow-sm rounded-sm w-full h-36 flex justify-around items-center">
            <span className=" bg-green-200 text-green-600 p-2 shadow-sm rounded-sm ">
            <HiUsers size={40} />
            </span>
            <div>
          ...
          <div className=" bg-white  shadow-sm rounded-sm w-full h-36 flex justify-around items-center">
            <span className=" bg-indigo-200 text-indigo-600 p-2 shadow-sm rounded-sm ">
              <HiCash size={40} />
            </span>
            <div>
          ...
          <div className=" bg-white  shadow-sm rounded-sm w-full h-36 flex justify-around items-center">
            <span className=" bg-pink-200 text-pink-600 p-2 shadow-sm rounded-sm ">
          ...
          <div className=" bg-white shadow-sm rounded-sm w-full h-36 flex justify-around items-center">
            <span className=" bg-amber-200 text-amber-600 p-2 shadow-sm rounded-sm ">
            <HiCurrencyBangladeshi size={40}/>
            </span>
            <div>
