...
const Header = () => {
  return (
    <section className='h-[550px] w-full grid place-content-center bg-cover bg-center head_bg'>
      <div className="">
        <div className=' '>
          <h1 className=' text-white text-3xl md:text-5xl font-extrabold'>Agricultural Tourism &</h1>
          <h1 className=' text-white text-3xl md:text-5xl font-extrabold'>Products Selling Platform </h1>
