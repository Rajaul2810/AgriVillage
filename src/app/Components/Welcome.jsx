            ...
            <div className=' flex justify-center items-center pt-20 pb-20 p-5 '>
                <div className='w-full md:w-3/4 grid grid-cols-1 md:grid-cols-2 place-items-center '>
                    <div className=' grid place-items-center'>
                        <Image className='h-80 rounded-s-md' placeholder='blur' src={village} mode='cover' alt='' />
                        <Image className=' rounded-md h-96 col-start-2 col-span-3' placeholder='blur' src={wel} mode='cover' alt='' />
                    </div>
                    <div className='p-5  w-full '>
                        ...
                        <div className=' text-black'>
                            <div className=' flex shadow-xl rounded-sm p-2 w-3/4 md:w-2/4 bg-white mb-2'>
                            ...
                            <div className=' flex gap-3 items-center pt-4'>
                                <Link href='/products' className='btn bg-gradient-to-r from-green-500 to-lime-400 shadow-lg text-xs text-white px-5 py-2 rounded-sm transform hover:scale-105 duration-500 flex items-center gap-1'>Buy Product <BsArrowRightCircle/></Link>
                                <Link href='/projects' className='btn bg-yellow-400 py-2 px-5 rounded-sm shadow-lg text-xs text-black  transform hover:scale-105 duration-500 flex items-center gap-1 hover:bg-yellow-500'>Visit Farm <BsArrowRightCircle/></Link>
                            </div>
                        </div>
                    </div>
