            ...
            <div className=' flex justify-center items-center pt-20 pb-20 p-5 '>
                <div className='w-full md:w-3/4 grid grid-cols-1 md:grid-cols-2 place-items-center '>
                    <div className=' grid place-items-center'>
                        <Image className='h-80 rounded-s-md' src={village} alt='' />
                        <Image className=' rounded-md h-96 col-start-2 col-span-3' src={wel} alt='' />
                    </div>
                    <div className='p-5  w-full '>
                        ...
                        <div>
                            ...
                            <div className=' flex gap-3 items-center pt-4'>
                                <Link href='/products' className='btn bg-gradient-to-r from-green-500 to-lime-400 shadow-lg text-xs text-white px-5 py-2 rounded-full transform hover:scale-105 duration-500 flex items-center gap-1'>Buy Product <BsArrowRightCircle/></Link>
                                <Link href='/projects' className='btn bg-yellow-400 py-2 px-5 rounded-full shadow-lg text-xs text-black  transform hover:scale-105 duration-500 flex items-center gap-1 hover:bg-yellow-500'>Visit Farm <BsArrowRightCircle/></Link>
                            </div>
                        </div>
                    </div>
