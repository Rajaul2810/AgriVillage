...
import { BsFacebook, BsFillCheckCircleFill, BsLinkedin, BsYoutube } from 'react-icons/bs'
    ...
    return (
        <section className='h-full bg-contain bg-center footer_bg'>
            <div className=" h-auto flex justify-center pt-5">
                <div className=' w-3/4 bg-slate-100 bg-opacity-95  rounded-sm grid sm:grid-cols-2 md:grid-cols-3 '>
                    <div className='m-5'>
                        ...
                        <p className=' text-sm'>Jagannath University <br /> 9-10 Chittaranjan Ave, Dhaka 1100</p>
                        <h1 className=' text-sm pt-3 pb-2 font-bold'>SOCIAL CONNECT</h1>
                        <div className='flex items-center gap-4'>
                            <a href='' className=' bg-white p-2 rounded-md hover:scale-105 duration-300'><BsYoutube size={20} color='green' /></a>
                            <a href='' className=' bg-white p-2 rounded-md hover:scale-105 duration-300'><BsFacebook size={20} color='green' /></a>
                            <a href='' className=' bg-white p-2 rounded-md hover:scale-105 duration-300'><BsLinkedin size={20} color='green' /></a>
                        </div>
                    </div>
                    <div className='m-5'>
            ...
            <div className=' bg-slate-900 p-5'>
                <p className=' text-white text-center'>&copy; Copyright, {new Date().getFullYear()} by AgriVillage</p>
            </div>
        </section>
    )
}
